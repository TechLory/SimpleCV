...
function WorkExpercience({save, dataObj, bigPreview}) {
  ...
  const textareaStyle = "w-full h-60 bg-neutral-900 px-3 py-1 rounded-md mt-1 font-semibold text-neutral-300"
              ...
              <div className="bg-neutral-800 rounded-l-lg px-4 w-full pt-8 pb-3 mt-1 ">
                ...
                <div className="flex">
                  ...
                  <div className="w-full">
                    <input type="text" className={inputStyle} name="position" id="position" value={item.position} onChange={(e) => handleInputChange(e, index)}/>
